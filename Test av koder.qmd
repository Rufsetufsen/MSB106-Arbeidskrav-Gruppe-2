...
tip <- pendl |>
  ...
  filter(knr24 != "9999")
```
 sum(Sysselsatte personer bosatt i regionen),
      Innpendlere = sum(Perssoner som pendler inn i regionen),
      Utpendlere = sum(Personer som pendler ut av regionen),
      Arbeidssted = sum(Sysselsatte personer med arbeidssted i regionen)
