...
boliger, noe som er mer tilgjengelig i periferien[@capello,s. 54]? Det
finnes mange mulige sentrifugale krefter som fungerer desentraliserende
på befolkningen, men vi har ikke grunnlag til å trekke konklusjoner på
dette ennå.
...
urbanisering, som et bredere kulturtilbud og flere ameniteter [@capello,
s.187]. En annen hypotese kan være at de i aldersgruppen 20-29 er på det
livsstadiet at de vil ta høyere utdanning - "learning by schooling" - og
at de derfor i større grad trekkes mot steder der det finnes
universiteter, som ofte er lagt til de større, mer sentrale byene
[@göcke2004].
...
med regionaløkonomisk teori om faktorjustering [@capello].
...
Noen av metodene som er blitt brukt gir ikke grunnlag for kausale tolkninger i seg selv. Disse resultatene må bli sett sammen med andre undersøkelser for å se om det faktisk finnes en forbindelse mellom ulike variabler. Vi har benyttet oss av flere metoder, som gir oss en innsikt i mulige forbindelser, men vi kunne ha gått enda dypere inn i undersøkelsen og brukt flere metoder for å få en dypere innsikt i forholdene, og om det da finnes endogenitetsutfordringer. Det finnes flere ulike måter for å håndtere mulige endogenitetsutfordringer, noe som https://www-sciencedirect-com.galanga.hvl.no/science/article/pii/S0019850117304133 har samlet i en artikkel. Artikkelen sier for eksempel at man kan bruke instrumentvariabler og benytte seg av høyere orden moment eller generalisert metode av momenter (https://www-sciencedirect-com.galanga.hvl.no/science/article/pii/S0019850117304133). 

Videre i undersøkelsen vår, kunne vi ha delt inn variablene i ulike grupper, for eksempel lav/middels/høy andel pendling, ulike aldersgrupper eller tatt hensyn til kjønn. Da kunne vi ha sett på hvordan forholdene endres dersom vi har hensyn til disse ulike gruppene. Dette hadde vært interessant å se nærmere på til videre forskning. Som tidligere nevnt, kunne det også vært lurt å se på ulike årsaker til at kommuner flest har mer innflytting enn utflytting.  
