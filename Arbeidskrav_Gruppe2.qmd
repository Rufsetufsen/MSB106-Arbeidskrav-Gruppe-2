...
Her vil vi ta for oss beregniner av korrelasjon mellom to variabler fra
de datasettene vi har hentet fra oppgave 1. Med en korrelasjonsberegning
vil vi få en korrelasjonskoeffisient, som er et tall mellom -1 og 1, der
den negative tallet vil bety en negativ korrelasjon og positivt tall
bety en posetiv korrelasjon mellom variablene. Vi skal altså beregne ut
sammenhengen mellom to variabler og se hvordan de påvirker hverandre
[@frøslie2025].
...
Korrelasjonsberegningene for årlige endringer viser at den
gjennomsnittlige korrelasjonen mellom befolkningsendringer og
sysselsettingsendringer er nær null (0.0157). Dette indikerer at den
sterke positive sammenhengen observert i pooled analyser i stor grad
reflekterer strukturelle forskjeller mellom kommuner, snarere enn
kortsiktig samvariasjon innen samme kommune over tid. Når korrelasjonen
er nærmest lik null, kan en se at variablene nesten ikke har en lineær
...
arbeidsledighet og årlig prosentvis endring i sysselsetting er -0.303.
Dette indikerer en moderat negativ sammenheng, der økt sysselsetting
typisk samvarierer med fallende ledighet. Sammenhengen er relativt
robust på tvers av kommuner, noe som tyder på at arbeidsmarkedet
reagerer mer direkte og kortsiktig på sysselsettingsendringer enn det
befolkningsutviklingen gjør.
